...
#define ACTUAL_TEMPERATURE_SENSORS 6
...
DeviceAddress inThermometer[MAX_TEMPERATURE_SENSORS] =
{
	...
	{ 0x28, 0x95, 0xC3, 0xBD, 0x04, 0x00, 0x00, 0xBA }, // inMain2  4  = 12
	{ 0x28, 0x13, 0x44, 0x67, 0x04, 0x00, 0x00, 0x62 }  // inMain3  5  = 14
};
DeviceAddress outThermometer[MAX_TEMPERATURE_SENSORS] =
{
	{ 0x28, 0x03, 0xCB, 0xE6, 0x03, 0x00, 0x00, 0xB1 }, // outMain   0 = 13 Šo pieņemam par etalonu (nulles punkts)
	...
	{ 0x28, 0xBB, 0xF4, 0x66, 0x04, 0x00, 0x00, 0x5F }, // outMain2  4  = 15
	{ 0x28, 0xDF, 0xA4, 0xEB, 0x03, 0x00, 0x00, 0xEB }  // outMain3  5 =  19
};
