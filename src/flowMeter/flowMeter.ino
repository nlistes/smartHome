...
{
	{ 0x28, 0x0C, 0xF5, 0x66, 0x04, 0x00, 0x00, 0x10 }, // inMain   =  2
	{ 0x28, 0x25, 0xDB, 0x66, 0x04, 0x00, 0x00, 0x6A }, // inBoiler = 11
	{ 0x28, 0x2E, 0xE1, 0x66, 0x04, 0x00, 0x00, 0xAB }  // inFloor  = 10
};
DeviceAddress outThermometer[MAX_TEMPERATURE_SENSORS] =
{
	{ 0x28, 0xFA, 0xA7, 0x97, 0x04, 0x00, 0x00, 0x38 }, // outMain   = 9
	{ 0x28, 0xE2, 0xE1, 0x66, 0x04, 0x00, 0x00, 0x49 }, // outBoiler = 6
	{ 0x28, 0x02, 0xD6, 0x66, 0x04, 0x00, 0x00, 0xB5 }  // outFloor  = 4
};
